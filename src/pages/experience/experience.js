...
export function Experience() {
    return (
        ...
        contentStyle={{ background: "#a61c3c", color: "#d8d78f" }}
        contentArrowStyle={{ borderRight: "7px solid  #a61c3c" }}
        date="Febuary 28th - March 1st 2025"
        iconStyle={{ background: "#4b4e70", color: "#208aae" }}
        icon=<img
        src={hackLogo}
        style={{ width: "45px", marginTop: "3px" }}
        ...
        >
        <h3 className="vertical-timeline-element-title">
        HenHacks Hackathon 2025
        </h3>
        <h4 className="vertical-timeline-element-subtitle">
        Newark, DE
        </h4>
        <p>
        My final Hackathon of college me and a team of 3 others built
        Flashcard Factory a LLM based Flashcard generator. My work 
        personally focused on the middle-end and Dev-Ops portions of
        the project hosting via personal AWS server and using FastAPI
        too communicate front and backend schemas.
        </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        className="vertical-timeline-element--work"
        ...
        <p>
        After 4 years I graduated with Cum Laude Honors a Degree in 
        Computer Science and Secondary Major in Data Science. During my
        time in University I found a love for Mathematics, Software Dev.
        learned and worked with new fields such as Dev-Op, Artificial
        Intelligence, Operating Systems which became some of my most
        primary parts of my skill set.
        </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        className="vertical-timeline-element--work"
