...
export function SmallCard({ title, quote, image, background, github, webLink, downloadFile, tech1, tech2, tech3, tech4, tech5, tech6, initalOpen = true }) {
    ...
    <div>
      ...
      <MotionCard
        ...
        sx={{
          ...
          borderColor: "#FF9B71",
          boxShadow: "15px 13px 8px rgba(0, 0, 0, 0.5)",
          ...
          position: iscardopened ? "relative" : "fixed",
          inset: iscardopened ? "auto" : "0 0 0 0",

          width: iscardopened ? "20vw" : "60vw",
          height: iscardopened ? "21vw" : "48vw",
      ...
      >
        <div>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: "28vw", justifyContent: iscardopened ? "center" : "none", alignItems: iscardopened ? "center" : "none", float: iscardopened ? "none" : "right", width: "100%" }}>
            <motion.img layout src={image} className="major-Image" style={{ float: iscardopened ? "auto" : "right", marginLeft: iscardopened ? "1.25vw" : "auto", marginRight: iscardopened ? "auto" : "2.5vw", marginTop: iscardopened ? ".5vw" : "0vw", height: iscardopened ? "17vw" : "27vw" }} />
              ...
              <motion.div className="linkGrid">
                {github ? (
                  <a href={github} onClick={handleDivClick}>
                    {" "}
                    <motion.img className="link" src={githubPic} />
                  </a>
                ) : null}
                ...
                {webLink ? (
                  <a href={webLink} onClick={handleDivClick}>
                    {" "}
                    <motion.img className="link" src={linkPic} />{" "}
                  </a>
                ) : null}
                ...
                {downloadFile ? (
                  <a href={downloadFile} onClick={handleDivClick} download>
                    {" "}
                    <motion.img className="link" src={downloadPic} />
                  </a>
                ) : null}
              </motion.div>
            )}
          ...
          <div style={{ display: "flex", flexDirection: "column", marginTop: iscardopened ? "0vw" : "2vw" }}>
            <div style={{ textAlign: "center" }}>
              <MotionTypo layout className="title" animate={{ fontSize: iscardopened ? "2vw" : "50px" }} sx={{ color: "#D8D78F", fontFamily: "Rubik, sans-serif", fontWeight: 500 }}>
                {title}
              </MotionTypo>
            ...
            <motion.div className="backgroundDiv" animate={{ y: iscardopened ? "27vw" : "0vw" }} transition={{ duration: 0.45, type: "spring", damping: 15, stiffness: 130 }}>
              <div className="backgroundHead">Background:</div>
              <div className="backgroundText">{background}</div>
            </motion.div>
          </div>
        </div>

        <div className="TechnologyHead">Technologies:</div>
