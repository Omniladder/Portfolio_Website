    ...
    <div>
      {iscardopened ? null : (
        <div
          ...
          style={{ pointerEvents: "auto", pointer: "none", zIndex: 99999 }}
        ></div>
      )}
      <MotionCard
        ...
        <div>
          <div
            style={{
              ...
              maxWidth: "28vw",
              justifyContent: iscardopened ? "center" : "none",
              alignItems: iscardopened ? "center" : "none",
              float: iscardopened ? "none" : "right",
              width: "100%",
            }}
          >
            <motion.img
              ...
              style={{
                float: iscardopened ? "auto" : "right",
                marginLeft: iscardopened ? "1.25vw" : "auto",
                marginRight: iscardopened ? "auto" : "2.5vw",
                marginTop: iscardopened ? ".5vw" : "0vw",
                height: iscardopened ? "17vw" : "27vw",
              }}
            />
          ...
          <div
            style={{
              display: "flex",
              flexDirection: "column",
              marginTop: iscardopened ? "0vw" : "2vw",
            }}
          >
            ...
            <motion.div
              ...
              animate={{ y: iscardopened ? "27vw" : "0vw" }}
              transition={{
                duration: 0.45,
                type: "spring",
                damping: 15,
