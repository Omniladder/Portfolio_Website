    ...
    onClick = {() => 
    {
      ...
      */
        ...
        sx={{
          ...
          width: iscardopened ? "30vw" : "60vw",
          height: iscardopened ? "35vw" : "48vw",
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", marginTop: iscardopened ? "auto" : "2vw" }}>
            <div style={{ textAlign: "center" }}>
              <MotionTypo layout className="title" animate={{ fontSize: iscardopened ? "40px" : "50px" }} sx={{ color: "#D8D78F", fontFamily: "Rubik, sans-serif", fontWeight: 500 }}>
                {title}
              </MotionTypo>
